...
%=============================================================================
\namanpm{Harry Senjaya Darmawan}{2017730067}
...
%=============================================================================
\judulINA{Screensaver Informasi Mahasiswa Wali}
\judulENG{Students' Information Screensaver}
%_____________________________________________________________________________
%=============================================================================
% 								BAGIAN X
%=============================================================================
...
% - langsung mulai setelah '{' awal, jangan mulai menulis di baris bawahnya
%=============================================================================
\abstrakINA{Seorang dosen wali perlu melakukan pemeriksaan data mahasiswa walinya, terutama data akademiknya secara berkala. Pemeriksaan tersebut dapat dilakukan dengan mengakses SIAKAD. Namun, SIAKAD memiliki kekurangan dimana dosen wali perlu melakukan \textit{login}, kemudian mencari serta memilih mahasiswa wali yang ingin dilihat. Sehingga dapat dikatakan proses tersebut tidaklah efisien.

\textit{Screensaver} Informasi Mahasiswa Wali merupakan aplikasi yang bertujuan agar komputer dapat menampilkan \textit{screensaver} yang memuat data-data akademik dari setiap mahasiswa wali. \textit{Screensaver} Informasi Mahasiswa Wali dibuat menggunakan bahasa pemrograman Java yang dibantu oleh JavaFX. Data yang ditampilkan pada \textit{screensaver} diambil langsung dari Portal Akademik Mahasiswa atau SIAKAD dengan memanfaatkan ekstraksi data situs web yang diimplementasikan menggunakan jsoup. Data yang telah diambil kemudian diolah ke dalam SIA Models.

Pengujian dari \textit{Screensaver} Informasi Mahasiswa Wali dilakukan oleh dosen pembimbing selaku dosen wali, dan penulis selaku mahasiswa. Berdasarkan hasil pengujian, \textit{screensaver} dapat berjalan dengan baik pada komputer dengan sistem operasi windows, dan menampilkan data-data mahasiswa wali.}
\abstrakENG{A lecturer needs to periodically check student's data, especially academic data. The check can be done by accessing SIAKAD. However, SIAKAD has a drawback where lecturer needs to log in, then search for and select the student they want to see. So it can be said that the process is not efficient.

Students' Information Screensaver is an application that aims to make the computer display a screensaver that contains academic data from each student. The Students' Information Screensaver was created using the Java programming language assisted by JavaFX. The data displayed on the screensaver is taken directly from the Portal Akademik Mahasiswa or SIAKAD by utilizing website data extraction which is implemented using jsoup. The data that has been taken is then processed into SIA Models.

Testing of the Students' Information Screensaver is carried out by the supervisor as a lecturer, and the writer as a student. Based on the test results, the screensaver can run well on a computer with a windows operating system, and displays student data.} 
%=============================================================================
...
% Petunjuk: hilangkan tanda << & >>, dan isi sesuai dengan data anda.
%=============================================================================
\kunciINA{\textit{Screensaver} Informasi Mahasiswa Wali, Portal Akademik Mahasiswa, Teknik Informatika UNPAR, JavaFX, jsoup, SIA Models}
\kunciENG{Students' Information Screensaver, Portal Akademik Mahasiswa, Teknik Informatika UNPAR, JavaFX, jsoup, SIA Models}
%=============================================================================
