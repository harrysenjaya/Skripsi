...
\subsection{Pembayaran}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.4]{Gambar/pembayaran.png}
...
\subsection{FRS/PRS}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.4]{Gambar/frs.png}
...
\subsection{Nilai}
    ...
    \begin{itemize}
        ...
        \end{figure}
         ...
         \begin{figure}[H]
        	\centering
        	\includegraphics[scale=0.41]{Gambar/nilai_dps_2.png}
       ...
       \begin{figure}[H]
        	\centering
        	\includegraphics[scale=0.36]{Gambar/nilai_rip.png}
