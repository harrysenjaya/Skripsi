...
Gambar \ref{fig:3_diagram_kelas_awal} merupakan diagram kelas awal \textit{screensaver}. Terdapat sebuah \textit{abstract class} yang bernama \texttt{DataPuller} yang memiliki 2 buah \textit{method} yaitu:
\begin{itemize}
