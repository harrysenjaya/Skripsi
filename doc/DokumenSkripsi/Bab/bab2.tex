...
% Sebuah elemen dapat merepresentasikan properti "statis" (terkadang disebut \textit{"attached property"}). Properti statis adalah properti yang hanya berguna dalam konteks tertentu. Properti statis tidak intrinsik ke kelas tempat mereka diterapkan, tetapi didefinisikan oleh kelas lain (seringkali, wadah induk dari sebuah kontrol).

% Properti statis diawali dengan nama kelas yang mendefinisikannya.
