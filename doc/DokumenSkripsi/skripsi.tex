...
\definecolor{color-diff}{RGB}{150,0,0}
\definecolor{color+diff}{RGB}{0, 150, 0}

\lstdefinelanguage{diff}{
  morecomment=[f][\color{blue}]{@@},     % group identifier
  morecomment=[f][\color{color-diff}]-,         % deleted lines 
  morecomment=[f][\color{color+diff}]+,       % added lines
